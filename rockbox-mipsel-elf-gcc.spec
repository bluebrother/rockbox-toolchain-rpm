...
BuildRequires:  rockbox-%{target}-binutils = 2.17 zlib-devel gawk
Requires:       rockbox-%{target}-binutils = 2.17
...
%changelog
* Sun Mar 11 2012 Dominik Riebeling <bluebrother@gmx.de> - 4.1.2-1
- initial version
